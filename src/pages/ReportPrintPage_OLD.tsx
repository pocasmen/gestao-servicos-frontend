            ...
            <div className="print-sheet">
                ...
                <footer className="report-footer">
                    <div className="services-summary">
                        ...
                        <div className="table-body">
                            {report.timeBlocks && report.timeBlocks.length > 0 ? (
                                report.timeBlocks.map((block, idx) => {
                                    ...
                                    return (
                                        <div className="table-row" key={idx}>
                                            <div>{start.toLocaleDateString('pt-PT')}</div>
                                            <div>{start.toLocaleTimeString('pt-PT', { hour: '2-digit', minute: '2-digit' })}</div>
                                            <div>{end.toLocaleTimeString('pt-PT', { hour: '2-digit', minute: '2-digit' })}</div>
                                            <div></div>
                                            <div>{hours}</div>
                                        </div>
                                    );
                                ...
                                <div className="table-row">
                                    <div>{new Date(report.serviceDate).toLocaleDateString('pt-PT')}</div>
                                    <div></div>
                                    <div></div>
                                    <div></div>
                    ...
                    <div className="total-summary">
                        <div className="total-label">TOTAL HORAS:</div>
                        <div className="total-value">{report.hours} h</div>
                    </div>
                </footer>
